...
const products = [
  {
    image: { src: "https://placehold.co/600x400.png", hint: "soap" },
    title: "Jabones Artesanales",
    description: "Elaborados con aceites esenciales y hierbas para una limpieza energética y nutritiva.",
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((product, index) => (
            <Card key={index} className="overflow-hidden shadow-lg transition-transform duration-300 ease-in-out hover:scale-102 hover:shadow-xl flex flex-col">
